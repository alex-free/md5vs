...
MD5VS makes it easy to verify the integrety of all files recursively in a specfied directory. MD5VS is very portable, it can use the BSD MD5 which comes with Mac OS X by default or the GNU MD5SUM which is on Linux and other non-*BSD systems, which is detected automatically.

Example:

Use the command:

./md5sum -c "/path/to/some/directoy"
...
./md5sum -v "/path/to/some/directory"
